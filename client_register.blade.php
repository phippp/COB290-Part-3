        ...
        <form action="#" method="post">
            ...
            <div id="equip-check-section">
                ...
                <div class="software-section">
                    ...
                    <div id="select-os">
                        ...
                        <select name="operating_system" id="os-system" class="select-default" >
                            ...
                            <!-- Receive data from db and put operating system names in option list -->
                            @foreach($osNames as $osName)
                                <option value = '{{$osName->id}}'>{{$osName->operating_system_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div id="select-app-software">
                        ...
                        <select name="app_software" id="app-software" class="select-default" >
                            <option selected> - </option>
                            <!-- Receive data from db and put softwares in option list -->
                ...
                <div id="hardware-section">
                    ...
                    <input type="text" name="serial_num" id="hardware-input" class="input-default">
                </div>
            </div>
            <br> <hr>
            ...
            <input type="text" name="title" id="query-title-input" class="input-default" value="{{old('title')}}">
            ...
            <textarea name="description" id="query-description-input" class="large-text-input">
            ...
            <div id="categorization-section">
                ...
                <div id="category-input-section">
                    ...
                    <div id="generic-categorization-container">  <!-- this div is CSS flex child   -->
                        ...
                        <select name="generic_category" id="generic-category" class="select-default">
                            <option selected> - </option>
                            <!-- Receive data from db and put generic problem types in option list -->
                            @foreach($generalCategories as $generalCategory)
                                <option value = {{$generalCategory->id}} >{{$generalCategory->problem_type}}</option>
                            @endforeach
                        </select>
                        <!-- unsure of how to do the error -->
                    </div>

                    <div id="specific-categorization-container">
                        <label for="specific_category" class="label-default"> Specific category</label> <br>
                        <select name="specific_category" id="specific-category" class="select-default">
                        <option selected> - </option>
                            <!-- Receive data from db and put specific problem types in option list -->
                            @foreach($specificCategories as $specificCategory)
                                <option value = {{$specificCategory->id}}>{{$specificCategory->problem_type}}</option>
                            @endforeach
                                <!--<option>Please pick a general category first</option>-->
                        </select>
                    </div>
                </div>
            ...
            <div id="assign-specialist-section" class="container-hide">
                ...
                <select name="specialist_location" id="spec_location" class="select-default" >
                    <option> - </option>
