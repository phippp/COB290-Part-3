...
var hardwareMap = {'serial_num': 0, 'make': 1, 'type': 2, 'name': 3};

var softwareRows = document.getElementById("software-table").rows;
var softwareMap = {'id': 0, 'name': 1, 'version': 2};
...
function updateSoftware(){
    ...
    var field = softwareMap[document.getElementsByName("software-type")[0].value];

    for(var i = 1; i < softwareRows.length; i++){

        var data = softwareRows[i].cells[field].innerHTML;
