...
<div class="nav-container"> <!-- this class applies background styling to our navigation-->
    ...
    <nav> <!-- This is a flex container and it will centers all the content that we will be showing-->
        ...
        <div id="primary-nav-links">
            <a href="{{ route('analyst') }}" class="{{  $navTitle == 'dashboard' ? 'nav-link-active' : '' }}"> Dashboard </a>
            
            <a href="{{ route('analyst_equipment') }}" class="{{  $navTitle == 'equipment' ? 'nav-link-active' : '' }}"> 
                Equipment 
            </a>
            
            <a href="{{ route('analyst_training') }}" class="{{  $navTitle == 'training' ? 'nav-link-active' : '' }}">
                Training 
            </a>

            <a href="{{ route('analyst_logfile') }}" class="{{  $navTitle == 'logfile' ? 'nav-link-active' : '' }}"> 
                Logfile 
            </a>
